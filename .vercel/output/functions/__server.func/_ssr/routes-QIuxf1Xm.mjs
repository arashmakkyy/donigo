...
import { i as useDongi, r as Route$1 } from "./router-6lSn0lNN.mjs";
import { S as totalSpent, a as DrawerContent, c as Input, d as cn, f as decodeGroup, h as formatMoney, i as Drawer$1, n as Button, o as DrawerDescription, s as DrawerTitle, t as AvatarStack } from "./share-Dsd5G7IZ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-QIuxf1Xm.js
...
function HomeScreen({ importToken }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "mx-auto min-h-dvh max-w-lg px-5 pb-28 pt-[max(1.25rem,env(safe-area-inset-top))]",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					!hydrated && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-28 rounded-2xl bg-card" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-28 rounded-2xl bg-card" })] }),
					hydrated && groups.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					hydrated && groups.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/g/$groupId",
						params: { groupId: g.id },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto max-w-lg px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))]",
