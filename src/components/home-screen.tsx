  ...
  return (
    <main className="mx-auto min-h-dvh max-w-lg px-5 pb-36 pt-[max(1.25rem,env(safe-area-inset-top))]">
      <header className="flex items-center justify-between">
        <div>
          <p className="text-xs font-medium tracking-[0.2em] text-muted">DONGI</p>
          <h1 className="mt-1 text-3xl font-medium tracking-tight">دونگی</h1>
        </div>
        <button
          type="button"
      ...
      <p className="mt-8 max-w-[18ch] text-lg leading-snug text-muted">
        هزینه‌ها را بنویس. دونگ را دونگی حساب می‌کند.
      </p>
